...
const imagePierre = new URL(require("d91b0a1219756d85"));
const imagePapier = new URL(require("519c5e34debece9"));
const imageCiseaux = new URL(require("ae1f27f35ae0e82"));
...
const btnClick = (event)=>{
    ...
    switch(_algosJs.chifoumi(choixJoueur, choixOrdinateur)){
        case 0:
            break;
        case 1:
...
},{"./algos.js":"85sBc","d91b0a1219756d85":"63ZuU","519c5e34debece9":"lkUnd","ae1f27f35ae0e82":"954z6"}],"85sBc":[function(require,module,exports) {
const paireADN = (sequence)=>{
    ...
    finalResult = [];
    for (base of sequence)finalResult.push([
        base,
        paires[base]
    ]);
    return finalResult;
...
},{}],"63ZuU":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('iumEF') + "pierre.e2f15643.png" + "?" + Date.now();
...
},{}],"lkUnd":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('iumEF') + "papier.29934a16.png" + "?" + Date.now();

},{"./helpers/bundle-url":"chiK4"}],"954z6":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('iumEF') + "ciseaux.45d784ce.png" + "?" + Date.now();

},{"./helpers/bundle-url":"chiK4"}]},["5qWSS","ijsRf"], "ijsRf", "parcelRequire4f02")
